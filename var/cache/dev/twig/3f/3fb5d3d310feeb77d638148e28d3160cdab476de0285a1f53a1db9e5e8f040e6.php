...
class __TwigTemplate_155a5d703fc10ad266a3302f77720a707dc005d61cc040b601b82d750cdcd028 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 11
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 11, $this->source); })()), 'form_start', ["attr" => ["class" => "container mt-5 w-50"]]);
        echo "
\t";
        // line 12
...
";
    ...
    {
        return array (  105 => 17,  99 => 14,  95 => 13,  91 => 12,  87 => 11,  82 => 8,  73 => 6,  68 => 5,  58 => 4,  35 => 1,);
    }
...
\t{{ form_start(registrationForm, {'attr': {'class' : 'container mt-5 w-50'}})}}
...
{% endblock %}
", "registration/register.html.twig", "/var/www/html/DWWM-2020-2021/symfony-Pierre-Camino/3_Blog/Mon_Blog/templates/registration/register.html.twig");
    }
}
